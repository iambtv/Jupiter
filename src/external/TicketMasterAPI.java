...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "d5ECCJ72yjpymGQL1HGfXER8Gx0XA25M";
...
//    		}
//    		try {
//    			keyword = java.net.URLEncoder.encode(keyword,"UTF-8");//对于所有字符统一编码，汉字这种本身难以被自动编码的就可以被编码 不会报错了
//    		}catch (Exception e) {
//    			e.printStackTrace();
//    		}
...
//    		return new JSONArray();
    		...
    		//example: https://app.ticketmaster.com/discovery/v2/events.json?apikey=d5ECCJ72yjpymGQL1HGfXER8Gx0XA25M
