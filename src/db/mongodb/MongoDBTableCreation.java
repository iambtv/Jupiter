	 ...
	 // Run as Java application to create MongoDB collections with index.
	  public static void main(String[] args) throws ParseException {
	    ...
	    // Step 3: create new collections.
		  ...
		  db.getCollection("items").createIndex(new Document("item_id", 1), indexOptions);//1代表从小到大排序

	    // Step 4: insert fake user data
		  db.getCollection("users").insertOne( new Document().append("first_name","John").append("last_name", "Smith").append("user_id", "1111").append("password", "3229c1097c00d497a0fd282d586be050"));
		  mongoclient.close();
